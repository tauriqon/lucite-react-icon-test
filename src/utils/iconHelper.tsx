...
export const KOREAN_KEYWORDS_MAP: Record<string, string[]> = {
  ...
  쇼파: ['sofa', 'chair'],
  의자: ['chair', 'sofa'],
  가구: ['sofa', 'bed', 'cabinet', 'wardrobe'],
  침대: ['beddouble', 'bed'],
  침실: ['beddouble', 'bed'],
  옷걸이: ['hanger'],
  옷: ['hanger', 'shirt', 'wardrobe'],
  의류: ['hanger', 'shirt'],
  패션: ['hanger', 'shirt', 'gem'],
  장난감: ['toybrick', 'baby'],
  블록: ['toybrick'],
  도서관: ['library', 'book'],
  책: ['library', 'book', 'notebook'],
  책방: ['library', 'book'],
  컴퓨터: ['laptop', 'monitor', 'keyboard'],
  노트북: ['laptop'],
  목욕: ['bath', 'shower'],
  욕조: ['bath'],
  세탁: ['washingmachine'],
  ...
  와인: ['wine', 'cup'],
  술: ['wine', 'cup', 'glass'],
  그림: ['paintbrush', 'pen', 'palette'],
  미술: ['paintbrush', 'palette'],
  붓: ['paintbrush'],
  영화: ['film', 'video', 'camera'],
  카메라: ['film', 'video', 'camera'],
  나침반: ['compass'],
  지도: ['compass', 'map'],
  길찾기: ['compass', 'map'],
  하트: ['heart'],
